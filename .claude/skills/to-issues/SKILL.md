...
If you have not already explored the codebase, do so to understand the current state of the code. Run `/domain-modeling` to load the project's domain glossary so issue titles and descriptions use the right vocabulary, and respect any ADRs in the area you're touching.
